...
enum node_kind {k_constant, k_identifier, k_type, k_var_decl, k_expression,
                ...
                k_block_statement, k_expr_statement, k_print_statement,k_switch_statement,
                k_return_statement, k_break_statement,k_try_statement,k_throw_statement};
...
struct s_switch_statement {
  ast_node header;              ///< AST header
  List parameters;              ///< effective parameters of a switch statement
  ast_node *expr_default;
};
